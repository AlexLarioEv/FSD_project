...
export const isManager = createSelector(getRoles,(roles) => roles?.includes(ERoleUser.MANAGER))
export const isAdmin = createSelector(getRoles,(roles) => roles?.includes(ERoleUser.ADMIN))
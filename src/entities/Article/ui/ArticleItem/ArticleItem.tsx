...
} from '../ArticleTextBlock/ArticleTextBlock';
import {
    EArticleBlockType,
    EArticleView,
    TArticle,
...
export const ArticleItem: FC<TArticleItemProps> = ({
    className,
    view,
    article,
}) => {
    ...
    const types = (
        <Text className={styles.types} description={type.join(', ')} />
    );
    const viewComponent = (
        ...
        content = (
            <>
                ...
                <AppImage
                    ...
                    src={img}
                    fallbackLoading={<Skeleton height={200} />}
                />
                {textBlock && (
                    <ArticleTextBlock
            ...
            <>
                <div className={styles.wrapperImg}>
                    ...
                    <AppImage
                        className={styles.img}
                        src={img}
                        fallbackLoading={<Skeleton height={'100%'} />}
                    />
                </div>

...
export const ProfilePageHeader: FC<TProfilePageHeaderProps> = ({
    className,
    readonly,
}) => {
    ...
    const buttonMenu = readonly ? (
        <Button onClick={handleEditProfile} theme={EButtonTheme.BORDER}>
            {t('edit')}
        </Button>
    ) : (
        <HStack gap={8}>
            <Button onClick={handleSaveProfile} theme={EButtonTheme.BORDER}>
                {t('save')}
            </Button>
            <Button
